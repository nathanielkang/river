...
class chernoffTreeRegressor(HoeffdingTree, base.Regressor):
    ...
    def _attempt_to_split(
        ...
        if len(best_split_suggestions) < 2:
            ...
            chernoff_bound = self._chernoff_bound(
            ...
            if best_suggestion.merit > 0.0 and (
                ...
                < 1 - chernoff_bound
                or chernoff_bound < self.tie_threshold
            ):
                should_split = True
        ...
        if should_split:
            ...
            leaf.manage_memory(
                split_criterion, last_check_ratio, last_check_vr, chernoff_bound
            )
